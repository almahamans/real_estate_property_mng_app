...
export const UpdatePropertyform = () => {
  const { handleEditItem } = useContext(PropertyContext);
...
const validateinput = () => {
  const newErrors = {};
  if (!property.title) newErrors.title = "property title is required";
